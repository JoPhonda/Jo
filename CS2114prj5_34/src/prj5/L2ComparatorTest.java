...
// -------------------------------------------------------------------------
/**
 * Tests that L2 comparator works
 * 
 * @author Christian Chung
 * @version Dec 4, 2025
 */
public class L2ComparatorTest
    extends TestCase
{
    ...
    public void testComp1()
    {
        ...
        assertEquals(70.0, comp.getEngagementRateByReach1(), 0.1);
        assertEquals(70.0, comp.getEngagementRateByReach2(), 0.1);
    }
    // ----------------------------------------------------------
    /**
