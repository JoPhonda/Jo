...
/**
 * Compares two influencers based on their engagement rate
 * 
...
{
    private double engagementRate1;
    private double engagementRate2;
    ...
    public L1Comparator()
    {
        this.engagementRate1 = 0;
        this.engagementRate2 = 0;
    }


    /**
     * Calculates the engagement rate for both influencers given and compares
     * them to check if influencer1's rate is less than, equal to, or greater
     * than influencer2's rate
     * 
     * @param influencer1
    ...
    public int compare(Influencer influencer1, Influencer influencer2)
    {
        ...
        engagementRate1 = (((double)influencer1Report.getTotalComments()
            + (double)influencer1Report.getTotalLikes())
            / (double)influencer1Report.getTotalFollowers()) * 100;

        // Calculating the engagement rate for influencer2
        FullReport influencer2Report = influencer2.getFullReport();
        engagementRate2 = (((double)influencer2Report.getTotalComments()
            + (double)influencer2Report.getTotalLikes())
            / (double)influencer2Report.getTotalFollowers()) * 100;

        double difference = engagementRate1 - engagementRate2;
        ...
        String month)
    {
        ...
        engagementRate1 = (((double)influencer1Report.getMonthlyComments()
        ...
        engagementRate2 = (((double)influencer2Report.getMonthlyComments()
    ...
    // ----------------------------------------------------------
    /**
     * Returns engagementRate1
     * @return engagementRate1
     */
    public double getEngagementRate1()
    {
        return engagementRate1;
    }
    ...
    // ----------------------------------------------------------
    /**
     * Returns engagementRate2
     * @return engagementRate2
     */
    public double getEngagementRate2()
    {
        return engagementRate2;
    }
